...
search_url = "https://api.twitter.com/2/tweets/search/recent?expansions=author_id&tweet.fields=text,created_at,lang,source&user.fields=location&max_results=100"
...
def main():
    ...
    # dic= {}
    # for tweet in json_indent["data"]:
    #     language = tweet["lang"]
    #     content = tweet["text"]
    #     dic[language].append(content)
    # for i in dic.keys():
    #     print(len(dic[i])) 
